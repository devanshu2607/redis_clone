...
// Connect to the ConC server
const client = new net.Socket();

client.connect(6379, "localhost", () => {
    console.log("Connected to ConC Cache Server!");
    console.log("Type your commands (e.g. SET key value, GET key). Type EXIT to quit.\n");
    rl.prompt();
});
...
client.on("data", (data) => {
    ...
    // Ignore the initial connection handshake message so it doesn't duplicate
